...
require_once($CFG->dirroot . '/question/type/ISAGEearabic/question.php');


/**
 * The ISAGEearabic question type.
 *
 * @copyright   

 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ISAGEearabic extends question_type {
 ...
 /**
    ...
    public function save_question_options($question) {
        ...
        /*Add the response to question_answers Table*/
     ...
     */
        ...
        // Save question options in question_ISAGEearabic table.
       
        if ($options = $DB->get_record('qtype_ISAGEearabic_options', array('questionid' => $question->id))) {
            // No need to do anything, since the answer IDs won't have changed
            // But we'll do it anyway, just for robustness.
 
            $DB->update_record('qtype_ISAGEearabic_options', $options);
        } else {
            $options = new stdClass();
            $options->questionid  = $question->id;
            
            $DB->insert_record('qtype_ISAGEearabic_options', $options);
        }
...
/**
 ...
 public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('qtype_ISAGEearabic_options', array('questionid' => $questionid));
    ...
    public function get_question_options($question) {
     ...
     if (!isset($question->options)) {
        ...
        $question->options = $DB->get_record('qtype_ISAGEearabic_options',
