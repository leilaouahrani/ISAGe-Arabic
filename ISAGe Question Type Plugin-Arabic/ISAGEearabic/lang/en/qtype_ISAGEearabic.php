...
$string['pluginname'] = 'The ISAGEe Arabic Question Type';
$string['pluginname_help'] = 'Enter a short answer by directly targeting the concept studied';
$string['pluginname_link'] = 'question/type/ISAGEearabic';
$string['pluginnameadding'] = 'Adding an ISAGEearabic question';
$string['pluginnameediting'] = 'Editing an ISAGEearabic question';
$string['pluginnamesummary'] = 'An ISAGEearabic question is a question that automatically assign student responses based on a semantic similarity with the teacher\'s model response .';
$string['test'] = 'test';
